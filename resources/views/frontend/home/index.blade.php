    ...
    <div class="carousel-inner">
      <div class="carousel-item" >
        <div
          ...
          style="background-image: url('frontend/images/home/dog.jpg')" 
        ></div>
        <div
        ...
        >
          <div class="p-3" style="max-width: 900px; ">
            ...
            <a href="ask-a-vet.html" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4"
              >Book Now</a
            >
            <a href="service.html" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4"
              >Learn More</a
            >
          </div>
        </div>
      ...
      <div class="carousel-item">
        <div
          class="carousel-image"
          style="background-image: url('frontend/images/home/AdobeStock_271437363.jpg')"
        ></div>
        <div
          class="carousel-caption d-flex flex-column align-items-center justify-content-center"
        >
          <div class="p-3" style="max-width: 900px">
            ...
            <a href="clinics.html" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4"
              >Book Now</a
            >
            <a href="service.html" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4"
              >Learn More</a
      ...
      <div class="carousel-item active">
        <div class="carousel-video">
          <video width="100%" height="100vh" autoplay loop>
            <source
              src="frontend/images/home/pexels-thirdman-8944060 (2160p).mp4"
              type="video/mp4"
            />
          </video>
        </div>
        ...
        <div class="col-lg-8 pb-5 pb-lg-0 px-3 px-lg-5">
          ...
          <h5 class="text-muted mb-3">
            <span class="text-primary"
              >We are here to help you and your pet.</span
            >
          </h5>
          <p class="mb-1">
          ...
          <div class="row px-3">
            <div class="col-12 p-0">
              <img
                ...
                src="frontend/images/home/about-1.jpg"
                alt=""
